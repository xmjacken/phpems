{x2;include:header}
<body data-spy="scroll" data-target="#myScrollspy"  onselectstart="return false;" onpaste="return false;" oncontextmenu="return false;" style="-moz-user-select:none;" onblur="autosubmit();">
...
//离开当前页面，自动交卷 2016.11.16 by jacken
function autosubmit(){
var yesno;
yesno = confirm("离开当前试卷，系统将自动交卷！")
if(yesno){submitPaper();}
}
</script>
<!--
{x2;include:footer}
