			        ...
			        <table class="table table-hover table-bordered">
			            ...
			            <tbody>
					        ...
					        <tr>
								...
								<td><a class="btn btn-primary" href="index.php?exam-teach-users-readpaper&ehid={x2;v:exam['ehid']}" target="_blank">阅卷</a>&nbsp;<a class="ajax btn btn-primary" href="index.php?exam-teach-users-examteacherdel&ehid={x2;v:exam['ehid']}&userid={x2;v:exam['ehuserid']}">删除</a>&nbsp;<a class="btn btn-primary hide" href="index.php?exam-teach-users-changescore&ehid={x2;v:exam['ehid']}" target="_blank">纠分</a></td>
					        </tr>
					        {x2;endtree}
			        	</tbody>
			        </table>
